...
rectifier.validate_anc_date()
rectifier.validate_unique_codes(position = 3, key = 'anc_visit', errcodes = ["missing_anc_visit", "invalid_anc_visit"] )
rectifier.validate_current_symptoms(position = 4)
rectifier.validate_location(position = 5)
rectifier.validate_weight(position = 6, key = 'mother_weight', errcode = "missing_mother_weight")
rectifier.validate_muac(position = 7)
