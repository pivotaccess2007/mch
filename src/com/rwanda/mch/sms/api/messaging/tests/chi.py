...
('CHI' , 'CHI 0788660270010918 01 04.09.2018 V2 VI AF CI HO WT4.5 MUAC6.4'),
('CHI_CHILD' , 'CHI 0788660270010918 01 04.09.2018 NV HO WT4.5 MUAC6.4'),
...
rectifier.validate_unique_codes(position = 4, key = 'vaccine', errcodes = ["missing_vaccine", "invalid_vaccine"] )
rectifier.validate_unique_codes(position = 5, key = 'vaccine_completion',
                                    errcodes = ["missing_vaccine_completion", "invalid_vaccine_completion"] )
rectifier.validate_current_symptoms(position = 6)
rectifier.validate_location(position = 7)
rectifier.validate_weight(position = 8, key = 'child_weight', errcode = "missing_child_weight")
rectifier.validate_muac(position = 9, key = 'muac', errcode = "missing_muac")
...
rectifier.validate_child_number(position = 2)
rectifier.validate_birth_date(position = 3)
rectifier.validate_unique_codes(position = 4, key = 'vaccine_completion',
                                    errcodes = ["missing_vaccine_completion", "invalid_vaccine_completion"], db_position = 5 )
rectifier.validate_location(position = 5, db_position = 7)
rectifier.validate_weight(position = 6, key = 'child_weight', errcode = "missing_child_weight")
rectifier.validate_muac(position = 7, key = 'muac', errcode = "missing_muac")
rectifier.invalid_sms_codes()
rectifier.validate_current_child()
rectifier.validate_duplicate_report()
