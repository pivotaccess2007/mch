...
('CCM' , 'CCM 0788660270010918 01 04.09.2018 PC MA DI OI  PR MUAC6.2'),
...
rectifier.validate_muac(position = 6, key = 'muac', errcode = "missing_muac")
