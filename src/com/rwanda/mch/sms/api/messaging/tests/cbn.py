...
rectifier.validate_unique_codes(position = 4, key = 'breastfeeding', errcodes = ["missing_breastfeeding", "invalid_breastfeeding"] )
rectifier.validate_weight(position = 5, key = 'child_weight', errcode = "missing_child_weight")
