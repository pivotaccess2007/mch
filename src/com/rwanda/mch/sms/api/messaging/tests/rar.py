...
('RAR_CHILD' , 'RAR 0788660270010918 01 04.09.2018 AP CO HE LA MC PA PS SC SL UN HO AL CW'),
...
('DTH' , 'DTH 0788660270010918 01 09.09.2015 HO ND'),
...
rectifier.validate_current_symptoms(position = 2, key = 'red_symptoms', db_position = 4)
rectifier.validate_location(position = 3, key = 'location', db_position = 5)
rectifier.validate_unique_codes(position = 4, key = 'intervention', 
                                errcodes = ['missing_intervention', 'invalid_intervention'], db_position = 6)
rectifier.validate_unique_codes(position = 5, key = 'mother_status', 
...
rectifier.validate_current_symptoms(position = 4, key = 'red_symptoms')
rectifier.validate_location(position = 5, key = 'location')
rectifier.validate_unique_codes(position = 6, key = 'intervention', errcodes = ['missing_intervention', 'invalid_intervention'])
rectifier.validate_unique_codes(position = 7, key = 'child_status', errcodes = ['missing_mother_status', 'invalid_child_status'])
rectifier.invalid_sms_codes()
