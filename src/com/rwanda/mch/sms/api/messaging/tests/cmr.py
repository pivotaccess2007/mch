...
('CCM' , 'CCM 0788660270010918 01 04.09.2018 PC MA JA DI OI  PR MUAC6.2'),
...
rectifier.validate_current_symptoms(position = 4, key = 'current_symptoms', errcode = 'missing_current_symptoms')
rectifier.validate_unique_codes(position = 5, key = 'intervention', errcodes = ['missing_intervention', 'invalid_intervention'])
rectifier.validate_unique_codes(position = 6, key = 'child_status', errcodes = ['missing_mother_status', 'invalid_child_status'])
