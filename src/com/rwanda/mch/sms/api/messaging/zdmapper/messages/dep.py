...
MESSAGES =  {
    ...
    "birth_date": {
            ...
            "duplicate_child_dep": { "en": "Child Number %(chino)s, born on %(dob)s has already been reported as DEP %(nid)s",
						"rw": "Raporo yo kwimuka kuri Nimero %(chino)s y'uyu mwana, wavutse kuri %(dob)s yaratanzwe kuri uwo mubyeyi %(nid)s.", "fr": ""},
            "duplicate_mother_dep": { "en": "Patient ID %(nid)s has already been reported as DEP.",
						"rw": "Raporo yo kwimuka yaratanzwe kuri uwo mubyeyi %(nid)s.", "fr": ""},
            "no_birth": { "en": "Child Number %(chino)s, born on %(dob)s, with mother %(nid)s has no BIR report.",
						"rw": "Nimero %(chino)s y'uyu mwana, wavutse kuri %(dob)s kuri uyu mubyeyi %(nid)s, nta raporo yo kuvuka yamutanzweho.", "fr": ""}
